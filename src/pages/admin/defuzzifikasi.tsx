...
export default function DefuzzifikasiPage() {
  ...
  return (
    <AdminLayout>
      <h1 className="text-xl font-bold mb-4 text-black">Hasil Defuzzifikasi</h1>
      ...
      {loading ? (
        ...
        <div className="overflow-y-auto max-h-[500px] border border-gray-400">
          <table className="table-auto w-full border-collapse border border-gray-400 text-black">
            ...
            <tbody>
              {displayedData.map((row, index) => (
                <tr key={row.id_data} className="hover:bg-gray-100 text-black">
                  <td className="border px-4 py-2">
                    {(currentPage - 1) * perPage + index + 1}
                  </td>
                  <td className="border px-4 py-2">{row.tahun}</td>
                  <td className="border px-4 py-2">{row.kecamatan}</td>
                  <td className="border px-4 py-2">{row.kepadatan_penduduk}</td>
